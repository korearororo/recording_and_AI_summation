...
param(
    ...
    [string]$GoogleDriveServiceAccountJson = "",
...
$envLines = @(
    ...
    "GOOGLE_DRIVE_SERVICE_ACCOUNT_JSON=$GoogleDriveServiceAccountJson"
    "GOOGLE_DRIVE_ROOT_FOLDER_ID=$GoogleDriveRootFolderId"
    "GOOGLE_DRIVE_OAUTH_CLIENT_ID=$GoogleDriveOAuthClientId"
    "GOOGLE_DRIVE_OAUTH_CLIENT_SECRET=$GoogleDriveOAuthClientSecret"
    "GOOGLE_DRIVE_OAUTH_REFRESH_TOKEN=$GoogleDriveOAuthRefreshToken"
